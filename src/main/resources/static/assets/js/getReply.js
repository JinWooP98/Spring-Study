...
let isFetching = false; // 데이터를 불러오는 중ㅇ에는 더 가져오지 않게 제어하기 위한 논리변수
...
async function scrollHandler(e) {
    ...
    // window.innerHeeight = 현재창에 보이는 세로 길이
    // window.scrollY = 스크롤을 내린 길이
    // document.body.offsetHeight 브라우저 전체 세로길이
    if (
