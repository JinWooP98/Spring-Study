        ...
        <div class="top-section">
          ...
          <div class="search">
            <form action="/board/list" method="get">
              ...
              <div class="amount">
                <div><a href="/board/list?amount=6" methods="get">6</a></div>
                <div><a href="/board/list?amount=18" methods="get">18</a></div>
                <div><a href="/board/list?amount=30" methods="get">30</a></div>
              </div>
            </form>
          </div>
          ...
          <nav aria-label="Page navigation example">
            <ul class="pagination pagination-lg pagination-custom">
              ...
              <c:if test="${maker.pageInfo.pageNo != 1}">
                <li class="page-item">
                  <a class="page-link" href="/board/list?pageNo=1&type=${s.type}&keyword=${s.keyword}&amount=${s.amount}">&lt;&lt;</a>
                </li>
              </c:if>
